...
const startConsumers = async () => {
    ...
    await applicationConsumer.subscribe({ topic: 'internship-applications', fromBeginning: false })
    ...
    await viewConsumer.subscribe({ topic: 'internship-views', fromBeginning: false })
    ...
    const registrationConsumer = kafka.consumer({ groupId: 'registration-group' })
    await registrationConsumer.connect()
    await registrationConsumer.subscribe({ topic: 'user-registrations', fromBeginning: false })
